        ...
        <div class="col-md-6">
            <div class="position-relative z-index-1 text-center text-lg-start mb-2 pt-5 mb-sm-0">
				...
				<figure class="fill-warning position-absolute bottom-0 end-0 me-5 d-none d-xl-block">
					<svg fill="#064689" width="42px" height="42px">
				...
				<figure class="fill-success position-absolute top-0 start-50 translate-middle-x mt-n5 ms-5">
					<svg fill="#064689" width="22px" height="21px">
                ...
                <ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
					<li class="list-inline-item me-2"> <i style="color: #064689" class='bx bxs-check-circle'></i> Learn with experts</li>
					<li class="list-inline-item me-2"> <i style="color: #064689" class='bx bxs-check-circle'></i> Get certificate</li>
					<li class="list-inline-item"> <i style="color: #064689" class='bx bxs-check-circle'></i> Get membership</li>
				</ul>
